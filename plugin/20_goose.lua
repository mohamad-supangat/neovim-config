if package.loaded['goose'] then
  require('goose').setup({
    ...
    ui = {
      ...
      layout = 'center', -- right|left|center (float window only)
    ...
    providers = {},
    system_instructions = 'kamu adalah sebuah pustaka pemograman paling lengkap, bantu saya sebaik mungkin, balas dengan bahasa indonesi secara singkat dan jelas tanpa perlu mendeskripsikan setiap langkah dan komentar penggunaan di setiap source code yang di hasilkan',
  })
